import {getLeftPosition, getCurrentColumns, getColumnMargin, setContainerHeight} from './calculations';
...
export function shuffle (ctx, $eles, refresh = false, markasComplete = true) {
  let margin = getColumnMargin(ctx.options.margin, ctx.options.marginBreakpoints);
